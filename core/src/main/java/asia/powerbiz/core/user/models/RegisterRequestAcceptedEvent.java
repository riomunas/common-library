...
import asia.powerbiz.core.user.models.data.RegisterRequestAcceptedEventData;
...
public record RegisterRequestAcceptedEvent(
        ...
        @JsonProperty("data")RegisterRequestAcceptedEventData data
        ) {
}
