...
import asia.powerbiz.core.user.models.data.UserRegisterRequestedEventData;
...
public record UserRegisterRequestedEvent(
        ...
        @JsonProperty("data") UserRegisterRequestedEventData data
        ) {
}
