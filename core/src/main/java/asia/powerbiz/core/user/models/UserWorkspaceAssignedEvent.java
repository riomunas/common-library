...
import asia.powerbiz.core.user.models.data.UserWorkspaceAssignedEventData;
...
@Revision("1.0")
public record UserWorkspaceAssignedEvent(
        ...
        @JsonProperty("data")UserWorkspaceAssignedEventData data
        ) {
}
